...
poset_data <- data.frame(
  Var1 = c(1, 2, 2, 3, 3, 4, 5, 5, 6, 7, 17),
  Var2 = c(5, 3, 4, 2, 4, 3, 6, 7, 6, 8, 1),
  Var3 = c(2, 1, 2, 3, 2, 4, 5, 4, 5, 6, 18)
)
rownames(poset_data) <- paste0("P", 1:11)
...
my_chain <- c("P2", "P3", "P5", "P7", "P9", "P10")  # Your custom chain - must be listed from the bottom up to follow the relationships correctly
...
analyze_relations(Z) #custom method to show comparable and non comparable for every point, the comparable follows chains so every item should be liisted
