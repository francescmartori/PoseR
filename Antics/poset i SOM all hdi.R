...
all_hdi <- read_csv("../30 years of HDI/Data/HDR23-24_Composite_indices_complete_time_series.csv")
...
png(file=paste("../30 years of HDI/POSet_allHDI.png", sep = ""), width=1100, height=860)
...
png(file=paste("../30 years of HDI/POSet_allHDI_avgHeights.png", sep = ""), width=1100, height=860)
...
png(file=paste("../30 years of HDI/SOM_allHDI_mapping.png", sep = ""), width=1100, height=860)
...
png(file=paste("../30 years of HDI/SOM_allHDI_codesplot.png", sep = ""), width=1100, height=860)
plot(dataPoset.model, type = "codes", main = "Codes Plot", shape="s")
dev.off()

png(file=paste("../30 years of HDI/SOM_allHDI_neighbours.png", sep = ""), width=1100, height=860)
...
png(file=paste("../30 years of HDI/SOM_allHDI_cluster.png", sep = ""), width=1100, height=860)
plot(dataPoset.model, type = "mapping", pchs = 19, shape = "straight", col = as.factor(all_hdi_noNA$Level)) 
legend('bottomright', legend = levels(as.factor(all_hdi_noNA$Level)), col = 1:4, cex = 0.8, pch = 16) 
add.cluster.boundaries(dataPoset.model, clust$cluster)
dev.off()

png(file=paste("../30 years of HDI/SOM_allHDI_clustermap.png", sep = ""), width=1100, height=860)
plot(dataPoset.model, type = "codes", shape = "s", bgcol = terrain.colors(4)[clust$cluster], main = "Cluster Map")
add.cluster.boundaries(dataPoset.model, clust$cluster)
dev.off()

png(file=paste("../30 years of HDI/SOM_allHDI_clusterlevels.png", sep = ""), width=1100, height=860)
palette(brewer.pal(n =4, name = "RdYlBu")) 
...
for(i in 1:length(Years)){
  ...
  png(file=paste("../30 years of HDI/Charts/POSET_HDI_", Years[i], ".png", sep = ""), width=1100, height=860)
  ...
  ggsave(filename = paste("../30 years of HDI/Charts/Sensitivity_HDI_", Years[i], ".png", sep = ""), 
  ...
  png(file=paste("../30 years of HDI/Charts/POSET_HDI_heights_", Years[i], ".png", sep = ""), width=1100, height=860)
...
for(i in 1:length(Years)){
  ...
  png(file=paste("../30 years of HDI/Charts/SOM_HDI", Years[i], "_mapping.png", sep = ""), width=1100, height=860)
  plot(dataPoset.model, type = "mapping", pchs = 19, shape = "straight", col = as.factor(all_hdi_noNA$Level)) 
  legend('bottomright', legend = levels(as.factor(all_hdi_noNA$Level)), col = 1:4, cex = 0.8, pch = 16)
  dev.off()
  
  png(file=paste("../30 years of HDI/Charts/SOM_HDI", Years[i], "_codesplot.png", sep = ""), width=1100, height=860)
  plot(dataPoset.model, type = "codes", main = "Codes Plot", shape="s")
  dev.off()
  
  png(file=paste("../30 years of HDI/Charts/SOM_HDI", Years[i], "_neighbours.png", sep = ""), width=1100, height=860)
  plot(dataPoset.model, type = "dist.neighbours", shape = "s")
  dev.off()
  ...
  png(file=paste("../30 years of HDI/Charts/SOM_HDI", Years[i], "_cluster.png", sep = ""), width=1100, height=860)
  plot(dataPoset.model, type = "mapping", pchs = 19, shape = "straight", col = as.factor(all_hdi_noNA$Level)) 
  legend('bottomright', legend = levels(as.factor(all_hdi_noNA$Level)), col = 1:4, cex = 0.8, pch = 16) 
  add.cluster.boundaries(dataPoset.model, clust$cluster)
  dev.off()
  
  png(file=paste("../30 years of HDI/Charts/SOM_HDI", Years[i], "_clustermap.png", sep = ""), width=1100, height=860)
  plot(dataPoset.model, type = "codes", shape = "s", bgcol = rainbow(4)[clust$cluster], main = "Cluster Map")
  add.cluster.boundaries(dataPoset.model, clust$cluster)
  dev.off()
  
  png(file=paste("../30 years of HDI/Charts/SOM_HDI", Years[i], "_clusterlevels.png", sep = ""), width=1100, height=860)
  palette(brewer.pal(n =4, name = "RdYlBu")) 
  plot(Z, col = as.factor(dataPoset.cluster$cluster), pch = 16)
  legend('bottomright', legend = levels(as.factor(dataPoset.cluster$cluster)), col = 1:4, pch = 16)
  dev.off()
...
#### Preparació de les dades ####
rank_all_hdi <- read_csv("../30 years of HDI/Data/HDR23-24_Composite_indices_complete_time_series.csv")
...
ggsave(filename = paste("../30 years of HDI/trend_avg_heigths.png", sep = ""), 
