# ----------------------------------------------------------------------------
# Original file: Clusters_Posets_Geography.R
# Geography of HDI: posets of k-means cluster centers per region,
# cluster stability analysis.
#
# Notes / known issues (code kept as in the original):
#  - expects data/HDI2022.txt and data/HDI2023.txt
#  - optim_centers = c(4, 7, 8, 9, 6) were chosen manually per region
# ----------------------------------------------------------------------------
...
png(file="output/POSet_HDI23_Clusters2.png", res = 240, height = 5000, width = 3600)
par(mfrow = c(5,3))
