# ----------------------------------------------------------------------------
# Original file: asdas.R
# Exploratory: hacked version of kohonen's internal codes-plot to tweak
# the legend layout (originally 'asdas.R').
#
# Notes / known issues (code kept as in the original):
#  - depends on dataPoset.model / simpleSOM from analysis/30-years-of-hdi/01_poset_som_all_hdi.R
